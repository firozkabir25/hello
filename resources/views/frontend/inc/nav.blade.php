        ...
        <div class="row">
            ...
            <div class="col-5 text-right d-none d-lg-block">
                <ul class="list-inline mb-0">
                        <li class="list-inline-item mr-3"><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:{{ get_setting('contact_email') }}" class="text-reset">{{ get_setting('contact_email')  }}</a>&nbsp;</li>
                        <li class="list-inline-item mr-3">{{ get_setting('contact_phone') }}</li>
                    @auth
                        @if(isAdmin())
