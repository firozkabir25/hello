    				...
    				<form action="{{ route('business_settings.update') }}" method="POST">
    	                ...
    	                <div class="form-group row">
                            ...
                            <div class="col-md-8">
        	                    ...
        	                    <input type="text" name="base_color" class="form-control" placeholder="#891198" value="{{ get_setting('base_color') }}">
    	                ...
    	                <div class="form-group row">
                            ...
                            <div class="col-md-8">
        	                    ...
        	                    <input type="text" name="base_hov_color" class="form-control" placeholder="#891198" value="{{  get_setting('base_hov_color') }}">
        						<small class="text-muted">{{ translate('Hex Color Code') }}</small>
                            </div>
    	                </div>
