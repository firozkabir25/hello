                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="file-preview box sm"></div>
                                                                   ...
                                                                   {{--Featured Products--}}
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('Featured Products Advertisement Image')}}</label>
                            <div class="col-sm-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose Files') }}</div>
                                    <input type="hidden" name="types[]" value="featured_products_add">
                                    <input type="hidden" name="featured_products_add" value="{{ get_setting('featured_products_add') }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm"></div>
                                <small>{{ translate('Will be used in Left Side of Featured Products Addvertisement Section ') }}</small>
                            </div>
                        </div>
                                                                {{-- For Advertisement Image --}}
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('Best Selling Advertisement Image')}}</label>
                            <div class="col-sm-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose Files') }}</div>
                                    <input type="hidden" name="types[]" value="best_selling_add">
                                    <input type="hidden" name="best_selling_add" value="{{ get_setting('best_selling_add') }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm"></div>
                                <small>{{ translate('Will be used in Left Side of Best Selling Addvertisement Section ') }}</small>
                            </div>
                        </div>
                                                                    {{-- best_seller_add --}}
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('Best Seller Advertisement Image')}}</label>
                            <div class="col-sm-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose Files') }}</div>
                                    <input type="hidden" name="types[]" value="best_seller_add">
                                    <input type="hidden" name="best_seller_add" value="{{ get_setting('best_seller_add') }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm"></div>
                                <small>{{ translate('Will be used in Left Side of Best Seller Addvertisement Section ') }}</small>
                            </div>
                        </div>
