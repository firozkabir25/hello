                ...
                <div class="card text-left">
                    <div class="card-body">
                        <div class="mb-5 text-center">
                            {{-- <img src="{{ uploaded_asset(get_setting('system_logo_black')) }}" class="mw-100 mb-4" height="40" alt="{{ get_setting('site_name') }}"> --}}
                        ...
                        <form class="pad-hor" method="POST" role="form" action="{{ route('login') }}">
                            ...
                            <h5 style="text-align: center; padding:5px;">OR</h5>
                        
                               <a class="btn btn-primary btn-lg btn-block" href="{{route('home')}}"> {{ translate('Back To Home') }}</a>
