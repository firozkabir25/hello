...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	// customer wallet
		...
		Route::get('/cwallet/index', 'CustomerWalletController@index')->name('cwallet.index');
		Route::get('/cwallet/edit/{id}', 'CustomerWalletController@edit')->name('cwallet.edit');
		Route::put('/cwallet/update/{id}', 'CustomerWalletController@update')->name('cwallet.update');
