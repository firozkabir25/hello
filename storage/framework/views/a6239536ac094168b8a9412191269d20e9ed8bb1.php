        ...
        <div class="row">
            ...
            <div class="col-5 text-right d-none d-lg-block">
                <ul class="list-inline mb-0">
                        <li class="list-inline-item mr-3"><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:<?php echo e(get_setting('contact_email')); ?>" class="text-reset"><?php echo e(get_setting('contact_email')); ?></a>&nbsp;</li>
                        <li class="list-inline-item mr-3"><?php echo e(get_setting('contact_phone')); ?></li>
...
<?php /**PATH /opt/lampp/htdocs/active/resources/views/frontend/inc/nav.blade.php ENDPATH**/ ?>