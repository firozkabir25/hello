                                ...
                                <?php $__empty_1 = true; $__currentLoopData = \App\Addon::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center">
                                            <img class="h-60px" src="<?php echo e(static_asset($addon->image)); ?>" alt="Image">
                                            <div class="mr-3 ml-5">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/active/resources/views/backend/addons/index.blade.php ENDPATH**/ ?>