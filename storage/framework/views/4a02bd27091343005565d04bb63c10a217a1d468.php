            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <?php endif; ?>
                 ...
                 <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-money-bill aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text"><?php echo e(translate('Customer Wallet')); ?></span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        <?php if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions))): ?>
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('cwallet.index')); ?>"class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Wallet')); ?></span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('h')); ?>"class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('H')); ?></span>
                                </a>
                            </li>
                           <?php endif; ?>
                    </ul>
...
<?php /**PATH /opt/lampp/htdocs/active/resources/views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>