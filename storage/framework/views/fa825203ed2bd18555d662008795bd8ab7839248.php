<div class="">
    <?php $__currentLoopData = \App\Address::where('user_id',$user_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /opt/lampp/htdocs/active/resources/views/pos/shipping_address.blade.php ENDPATH**/ ?>