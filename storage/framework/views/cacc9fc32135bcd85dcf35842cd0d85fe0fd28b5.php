    ...
    <section class="mb-4">
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <img src="<?php echo e(uploaded_asset(get_setting('best_selling_add'))); ?>" class="mw-100 mb-4" height="350" alt="<?php echo e(get_setting('site_name')); ?>">
                    </div>
                    <div class="col-md-10">
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/active/resources/views/frontend/partials/best_selling_section.blade.php ENDPATH**/ ?>