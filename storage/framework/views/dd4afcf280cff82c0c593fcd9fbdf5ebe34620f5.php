                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control aiz-selectpicker" name="symbol_format">
                                <option value="1" <?php if(\App\BusinessSetting::where('type', 'symbol_format')->first()->value == 1): ?> selected <?php endif; ?>>[Symbol] [Amount]</option>
                                <option value="2" <?php if(\App\BusinessSetting::where('type', 'symbol_format')->first()->value == 2): ?> selected <?php endif; ?>>[Amount] [Symbol]</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control aiz-selectpicker" name="decimal_separator">
                                <option value="1" <?php if(\App\BusinessSetting::where('type', 'decimal_separator')->first()->value == 1): ?> selected <?php endif; ?>>1,23,456.70</option>
                                <option value="2" <?php if(\App\BusinessSetting::where('type', 'decimal_separator')->first()->value == 2): ?> selected <?php endif; ?>>1.23.456,70</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control aiz-selectpicker" name="no_of_decimals">
                                <option value="0" <?php if(\App\BusinessSetting::where('type', 'no_of_decimals')->first()->value == 0): ?> selected <?php endif; ?>>12345</option>
                                <option value="1" <?php if(\App\BusinessSetting::where('type', 'no_of_decimals')->first()->value == 1): ?> selected <?php endif; ?>>1234.5</option>
                                <option value="2" <?php if(\App\BusinessSetting::where('type', 'no_of_decimals')->first()->value == 2): ?> selected <?php endif; ?>>123.45</option>
                                <option value="3" <?php if(\App\BusinessSetting::where('type', 'no_of_decimals')->first()->value == 3): ?> selected <?php endif; ?>>12.345</option>
                            </select>
                        </div>
                    </div>
        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(translate('Currency symbol')); ?></th>
                    <th><?php echo e(translate('Currency code')); ?></th>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/active/resources/views/backend/setup_configurations/currencies/index.blade.php ENDPATH**/ ?>