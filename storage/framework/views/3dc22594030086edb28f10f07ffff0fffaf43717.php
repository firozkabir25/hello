    ...
    <div class="card-body">
        <table class="table aiz-table">
            ...
            <tr>
                ...
                <th><?php echo e(translate('Due Amount')); ?></th>
                ...
                <?php if($affiliate_user->user != null): ?>
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <!-- <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="<?php echo e(route('sellers.destroy', $affiliate_user->id)); ?>" title="<?php echo e(translate('Delete')); ?>">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/active/resources/views/affiliate/users.blade.php ENDPATH**/ ?>